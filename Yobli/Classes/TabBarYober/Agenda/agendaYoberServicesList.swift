//
//  agendaYoberServicesList.swift
//  Yobli
//
//  Created by Francisco javier Moreno Torres on 30/07/21.
...
class agendaYoberServicesList: UIViewController {
    ...
    func query(yober: PFObject){
        ...
        let queryToReservation = PFQuery(className: "Service")
...
extension agendaYoberServicesList: UITableViewDelegate, UITableViewDataSource{
